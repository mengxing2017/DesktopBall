...
QT_MOC_LITERAL(1, 9, 12), // "timeout_info"
QT_MOC_LITERAL(2, 22, 0), // ""
QT_MOC_LITERAL(3, 23, 7) // "getInfo"

    },
    "ShowInfo\0timeout_info\0\0getInfo"
};
...
void ShowInfo::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ShowInfo *_t = static_cast<ShowInfo *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->timeout_info(); break;
...
const QMetaObject ShowInfo::staticMetaObject = {
    { &QMainWindow::staticMetaObject, qt_meta_stringdata_ShowInfo.data,
      qt_meta_data_ShowInfo,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *ShowInfo::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ShowInfo.stringdata0))
        return static_cast<void*>(const_cast< ShowInfo*>(this));
